...
export const it: Translations = {
  ...
  home: {
    whySection: {
      ...
      intro: {
        title:
          "MyBalance è per chi vuole davvero capire dove vanno i propri soldi.",
        description:
      ...
      forWho: {
        ...
        items: {
          ...
          spreadsheetUsers:
            "Usi (o ami) i fogli di calcolo ma vuoi un'interfaccia più comoda",
          privacyConscious:
            "Dai valore alla privacy e alla proprietà dei tuoi dati",
          controlFreaks:
            'Vuoi controllo totale, non grafici "carini" ma inutili',
        },
        conclusion:
    ...
    comingSoonSection: {
      ...
      description:
        "L'app è quasi pronta. Iscriviti per essere avvisato al lancio.",
      buttons: {
        ios: "Scarica per iOS",
  ...
  techStack: {
    ...
    sections: {
      mobileApp: {
        ...
        items: {
          reactNative:
            "React Native + Expo: iOS e Android nativi da un'unica codebase.",
      ...
      dataStorage: {
        ...
        items: {
          googleSheets:
            "Google Sheets API: I tuoi dati finanziari restano nel tuo Drive.",
          oauth: "OAuth 2.0: Autenticazione sicura basata su token.",
          noCloud:
            "Nessun Cloud Storage: Non vediamo né memorizziamo le tue transazioni.",
          export:
            "Esporta Sempre: Il tuo foglio di calcolo è sempre accessibile.",
        },
      },
      security: {
        ...
        items: {
          ...
          tokenRefresh:
            "Aggiornamento Token: Riautenticazione senza interruzioni.",
      ...
      openSource: {
        ...
        items: {
          ...
          community:
            "Community-Driven: Costruito per gli utenti, dagli utenti.",
      ...
      sections: {
        ...
        googleApi: {
          ...
          dataAccessed: {
            ...
            intro:
              "Quando accedi con Google, MyBalance richiede le seguenti autorizzazioni OAuth:",
            items: [
              {
