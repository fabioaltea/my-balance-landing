export const en = {
  ...
  hero: {
    ...
    description:
      "A modern personal finance tracker that stores all your data in your own Google Sheet. Privacy-first, open source, and beautifully simple.",
  ...
  features: {
    ...
    automation: {
      ...
      description:
        "Use Shortcuts to automate entries. Tap once to log your morning coffee or monthly subscriptions.",
    },
  },
  ...
  home: {
    whySection: {
      ...
      forWho: {
        ...
        items: {
          dataLovers:
            "You want to see every number, without filters or limitations",
          spreadsheetUsers:
            "You use (or love) spreadsheets but want a more convenient interface",
          privacyConscious: "You value privacy and ownership of your data",
          controlFreaks:
            'You want total control, not "pretty" but useless charts',
        },
        conclusion:
          "In short: if you want to decide how to read your money, MyBalance is your home.",
      },
      origin: {
        title: "Where MyBalance comes from",
        intro:
          "It all started from a frustration.\nWe were tired of finance apps that:",
        items: {
    ...
    transactionsSection: {
      ...
      example: {
        ...
        description:
          "You pay €48 in cash for everyone at the pizzeria. Your friends pay you back: €25 via bank transfer to Intesa San Paolo, €10 to Trade Republic. Total expense for you? Just €13. One movement captures it all.",
    ...
    comingSoonSection: {
      title: "Coming Soon",
      subtitle:
        "We're putting the finishing touches on MyBalance. Be among the first to take control of your finances.",
      description:
        "The app is almost ready. Sign up to be notified when we launch.",
      buttons: {
  ...
  howItWorks: {
    ...
    subtitle:
      "Your personal finance tracker that stores everything in your own Google Sheet. Full data ownership, zero compromises.",
    steps: {
      1: {
        title: "Sign in with Google",
        description:
          "Authenticate with your Google account. MyBalance automatically creates a dedicated Google Sheet in your Drive to store all your financial data. You own it completely.",
      },
      2: {
        title: "Set Up Your Accounts",
        description:
          "Add your bank accounts, cash, credit cards, and investment accounts. Customize each with a name and color. Track balances across all your accounts in one place.",
      },
      3: {
        title: "Track Your Transactions",
        description:
          "Add income and expenses with a single tap. Categorize transactions, split them across accounts, and optionally add location. Everything syncs instantly to your Google Sheet.",
      },
      4: {
        title: "Set Up Recurring Transactions",
        description:
          "Define recurring expenses like rent, subscriptions, or salary. MyBalance tracks expected vs actual occurrences and notifies you of missing entries with status badges.",
      },
      5: {
        title: "Visualize Your Finances",
        description:
          "View income vs expense charts, category breakdowns, and monthly trends. See your financial summary at a glance with the dashboard's interactive cards.",
      },
      6: {
        title: "Forecast Your Balance",
        description:
          "MyBalance analyzes your spending patterns and recurring transactions to predict your end-of-month balance. Stay ahead of your finances with intelligent forecasting.",
      },
    },
    stepLabel: "Step",
    finalCard: {
      ...
      description:
        "All your financial data lives in a Google Sheet on your personal Drive. Access it anytime, edit it manually, export it however you want. No vendor lock-in, no hidden databases. MyBalance is just a beautiful interface for your own spreadsheet.",
    },
  },
  ...
  techStack: {
    ...
    subtitle:
      "Built with modern technologies for speed, security, and complete data ownership.",
    sections: {
      mobileApp: {
        title: "Mobile App",
        items: {
    ...
    cta: {
      ...
      description:
        "Start tracking your finances the privacy-first way. Your data belongs to you, not to us.",
    ...
    privacyPolicy: {
      ...
      sections: {
        ...
        dataTypes: {
          ...
          intro:
            "Among the Personal Data collected by this Application, either directly or through third parties, are:",
          items: ["Usage Data", "Tracking Tools"],
          details:
            "Complete details on each type of Personal Data collected are provided in the dedicated sections of this privacy policy or through specific informative texts displayed before data collection.",
          provided:
          ...
          cookies:
            "Any use of Cookies - or other tracking tools - by this Application or by the owners of third-party services used by this Application serves the purpose of providing the Service requested by the User, in addition to the other purposes described in this document and in the",
          cookiePolicy: "Cookie Policy",
          responsibility:
        ...
        processing: {
          ...
          location: {
            ...
            transfer:
              "The User's Personal Data may be transferred to a country other than the one in which the User is located. To obtain more information about the location of processing, the User can refer to the section on details of Personal Data processing.",
          },
          retention: {
        ...
        processingDetails: {
          ...
          hosting: {
            ...
            description:
              "This type of service has the purpose of hosting Data and files that allow this Application to function and be distributed or to provide a ready-to-use infrastructure for running specific features or parts of this Application.",
            distributed:
        ...
        euInfo: {
          ...
          legalBasis: {
            ...
            clarification:
              "It is always possible to request the Data Controller to clarify the specific legal basis of each processing and in particular to specify whether the processing is based on the law, provided for by a contract, or necessary to conclude a contract.",
          },
          retention: {
        ...
        gdprRights: {
          ...
          rights: [
            {
              strong: "Withdraw consent at any time.",
              text: "The User can withdraw consent to the processing of their Personal Data previously given.",
            },
            {
              strong: "Object to the processing of their Data.",
              text: "The User can object to the processing of their Data when it occurs on a legal basis other than consent.",
            },
            {
              strong: "Access their Data.",
              text: "The User has the right to obtain information about the Data processed by the Data Controller, certain aspects of the processing, and to receive a copy of the Data processed.",
            },
            {
              strong: "Verify and request rectification.",
              text: "The User can verify the accuracy of their Data and request its update or correction.",
            },
            {
              strong: "Obtain processing restriction.",
              text: "The User can request the restriction of processing of their Data. In this case, the Data Controller will not process the Data for any other purpose than their storage.",
            },
            {
              strong: "Obtain deletion or removal of their Personal Data.",
              text: "The User can request the deletion of their Data by the Data Controller.",
            },
            {
              strong:
                "Receive their Data or have it transferred to another controller.",
              text: "The User has the right to receive their Data in a structured, commonly used, and machine-readable format and, where technically feasible, to have it transferred without obstacles to another controller.",
            },
            {
              strong: "Lodge a complaint.",
              text: "The User can lodge a complaint with the competent personal data protection authority or take legal action.",
            },
          ],
          transferInfo:
          ...
          opposition: {
            ...
            marketing:
              "Users are informed that, if their Data is processed for direct marketing purposes, they can object to the processing at any time, free of charge and without providing any reason. If Users object to processing for direct marketing purposes, Personal Data will no longer be processed for such purposes. To find out if the Data Controller processes Data for direct marketing purposes, Users can refer to the respective sections of this document.",
          },
          howTo: {
        ...
        additionalInfo: {
          ...
          changes: {
            ...
            text2:
              "If the changes affect processing whose legal basis is consent, the Data Controller will obtain the User's consent again, if necessary.",
          },
        },
        googleApi: {
          title: "Google API Services — User Data Policy",
          intro:
            "MyBalance's use and transfer of information received from Google APIs adheres to the Google API Services User Data Policy, including the Limited Use requirements. This section describes precisely how we access, use, store, and protect data obtained through Google OAuth.",
          dataAccessed: {
            title: "Google Data We Access",
            intro:
              "When you sign in with Google, MyBalance requests the following OAuth permissions:",
            items: [
              {
                scope: "openid / profile / email",
                purpose:
                  "Used solely to identify you, create or retrieve your account, and display your name and profile picture within the app. We do not use this information for any other purpose.",
              },
              {
                scope: "https://www.googleapis.com/auth/spreadsheets",
                purpose:
                  "Used exclusively to create, read, and update a single dedicated Google Spreadsheet in your own Google Drive, where all your personal financial data is stored. MyBalance never accesses any other spreadsheets or files in your Drive beyond the one it creates for you.",
              },
            ],
          },
          limitedUse: {
            ...
            intro:
              "Data obtained from Google APIs is used strictly and solely for the following purposes:",
            items: [
    ...
    termsOfService: {
      ...
      sections: {
        ...
        dataWeStore: {
          ...
          deletion:
            "All data stored on our servers is permanently deleted upon account deletion. To request deletion, contact us at fabio.f2001@gmail.com.",
        },
