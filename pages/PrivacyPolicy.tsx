  ...
  return (
    <div className="pt-32 pb-20 px-4 max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300 space-y-8">
        {/* Titolare */}
        <section>
          <h2 className="text-2xl font-semibold text-[#2f4f3f] dark:text-white mt-8 mb-4">
        ...
        <section>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mb-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {s.processingDetails.hosting.vercel.location}
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {s.processingDetails.hosting.vercel.data}
            </p>
          </div>

          <h3 className="text-xl font-semibold text-[#2f4f3f] dark:text-white mt-6 mb-3">
            {s.processingDetails.externalContent.title}
          </h3>
          <p className="mb-4 whitespace-pre-line">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {s.processingDetails.externalContent.googleFonts.location}
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            {s.gdprRights.rights.map((right, i) => (
              <li key={i}>
                <strong>{right.strong}</strong> {right.text}
              </li>
            ))}
          </ul>
        ...
        <section className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-6 mt-8">
          <h2 className="text-2xl font-semibold text-[#2f4f3f] dark:text-white mb-4">
            {s.googleApi.title}
          </h2>
          <p className="mb-6 whitespace-pre-line">{s.googleApi.intro}</p>

          <h3 className="text-xl font-semibold text-[#2f4f3f] dark:text-white mt-4 mb-3">
            {s.googleApi.dataAccessed.title}
          </h3>
